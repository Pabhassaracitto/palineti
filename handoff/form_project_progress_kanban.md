...
Mục tiêu Sprint: Load data cho tất cả các lessons (1-26) và chỉnh sửa luồng chọn ngày học.

📋 Backlog (Kho tính năng / Nhiệm vụ lâu dài)
🚀 Features (Tính năng mới)
[x] Hoàn thành soạn thảo nội dung Lessons 21-26.
...
[x] Rà soát, kiểm định lại chất lượng data lessons từ bài 1 -> 26 (Đã hoàn thiện logic metadata cho toàn bộ 26 bài học để export ra HomeScreen).
...
✅ Hoàn thành tích hợp lessons 21-26.
...
✅ Hợp nhất dự án: Đổi tên, sửa lỗi import, fix build action (2026-07-25).
...
[x] Truy cập HomeScreen hiện đủ 26 lessons (đã bổ sung đầy đủ metadata cho các bài 5,6,9,10,12,16,20, 21-26).
